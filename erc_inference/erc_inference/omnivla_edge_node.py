...
class OmniVLAEdgeNode(Node):
    def __init__(self):
        ...
        # Control parameters: defaults in motion_control.DEFAULT_PARAMS, values
        # and rationale in config/controller.yaml. All of them can be changed
        # live with `ros2 param set`; _on_set_parameters rejects invalid sets.
